...
export default function AdminModule({ onLogout }: AdminModuleProps) {
  ...
  // Active Sidebar Tabs derived from routing
          ...
          <div className="flex flex-col gap-6 animate-fade-in pb-16">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Audit real-time delivery status, trigger mock telemetry pings, toggle active shifts, and search systemic event logs.
              </p>
            </div>
